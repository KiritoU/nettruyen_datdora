...
class Crawler:
    def __init__(self, database) -> None:
        self._datdora = Datdora(database=database)
    ...
    def crawl_comic(self, href: str):
        ...
        comic_id = self._datdora.get_or_insert_comic(comic_details)
        ...
        inserted_chapters_slug = self._datdora.get_backend_chapters_slug(comic_id)
